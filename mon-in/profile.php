...
<head>
    ...
    <title>Mijn profiel - Mon-In</title>
...
<nav class="navbar navbar-expand navbar-dark bg-primary">
    <div class="container">
        ...
        <div class="navbar-nav ms-auto">
            <a class="nav-link bi-house-door" href="index.php">Home</a>
            <a class="nav-link active bi-person" href="profile.php">Profile</a>
        ...
        <div class="p-4">
            ...
            <?php else: ?>
                <div class="avatar-placeholder">
                    <i class="bi bi-person-fill bi-person"></i>
                </div>
            <?php endif; ?>
        ...
        <?php foreach ($posts as $post): ?>
            ...
            <div class="mb-3">
                ...
                <div class="d-flex align-items-center gap-3">
                    <a href="like.php?post_id=<?php echo $post['id']; ?>&redirect=profile.php" class="text-decoration-none text-muted">
                        <i class="bi bi-hand-thumbs-up<?php echo in_array($post['id'], $likedPosts) ? '-fill text-primary' : ''; ?>"></i>
                        <?php echo $post['like_count']; ?>
                    </a>

                    <a href="delete.php?post_id=<?php echo $post['id']; ?>&redirect=profile.php"
